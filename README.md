...
1. Update the `DEPLOYPROVIDER` value in your local version of [lib/handle_job.js](https://raw.githubusercontent.com/stelligent/codepipeline-opsworks-deployer/master/lib/handle_job.js) with the name of the Deploy Provider (i.e. the name of the custom action you created). Save this file.
