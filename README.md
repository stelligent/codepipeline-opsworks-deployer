...
* Make note of the *SNS ARN* and the *SNS Event Subscription ARN* by going to [SNS](https://console.aws.amazon.com/sns/) and selecting the Topic you'd previously created.
